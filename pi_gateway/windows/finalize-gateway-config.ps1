...
cloud_url/auth_token plus the credential-reference-only raw Convene telemetry path,
...
try {
    ...
    Write-Host "Convene telemetry: $($ConveneApi.TrimEnd('/'))/machine/publish (exact raw source names)"
